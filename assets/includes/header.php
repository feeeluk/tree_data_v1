...
<head>
	...
	<link rel="icon" type="image/x-icon" href="<?php echo $path; ?>assets/images/favicon/favicon.png">
...
<body>
	...
	<div id="outline">
        ...
        <div id="title">
			...
			<form id="search_form" name="search_form" method="GET" action="<?php echo $path; ?>pages/search/search_result.php">
				<label>Search:</label>
